...
<head>
    ...
    <title>
        @yield('title')
        | {{ config('variables.templateName') ?: config('app.name') }} - {{ config('variables.templateSuffix') ? config('variables.templateSuffix') : 'Dashboard' }}
    </title>
    <meta
        name="description"
    ...
    @include('base::components.dashboard.layouts.sections.styles' . $isFront)
    ...
    @include('base::components.dashboard.layouts.sections.scriptsIncludes' . $isFront)
</head>
...
<body>
    ...
    @include('base::components.dashboard.layouts.sections.scripts' . $isFront)

    {{-- Session flash messages (SweetAlert modals) --}}
    @include('base::components.dashboard.layouts.message')
</body>
</html>
