...
return [
    ...
    */
    ...
    'confirmed' => 'عذراً، تأكيد :attribute غير متطابق. يرجى التأكد من التطابق.',
    'current_password' => 'عذراً، كلمة المرور الحالية غير صحيحة. يرجى إدخال كلمة المرور الصحيحة.',
    ...
    'email' => 'عذراً، يرجى إدخال عنوان بريد إلكتروني صالح.',
    'ends_with' => 'يجب أن ينتهي :attribute بأحد القيم التالية: :values.',
    'enum' => ':attribute المحدد غير صالح.',
    'exists' => 'عذراً، القيمة المختارة لـ :attribute غير صحيحة أو غير موجودة.',
    ...
    'min' => [
        ...
        'string' => 'عذراً، يجب أن لا يقل :attribute عن :min أحرف.',
    ],
    ...
    'required' => 'عذراً، يرجى إدخال :attribute.',
    ...
    'unique' => 'عذراً، :attribute مُستخدم من قبل. يرجى اختيار قيمة أخرى.',
    ...
    'errors_occurred' => 'عذراً، حدثت أخطاء في البيانات المدخلة. يرجى تصحيح الحقول أدناه والمحاولة مرة أخرى.',
    ...
    */
    ...
    'custom' => [
        ...
        'password' => [
            'min' => 'عذراً، كلمة المرور يجب أن لا تقل عن 8 أحرف.',
            'required' => 'عذراً، يرجى إدخال كلمة المرور.',
            'confirmed' => 'عذراً، تأكيد كلمة المرور غير متطابق. يرجى إدخال نفس كلمة المرور في الحقلين.',
            'letters' => 'عذراً، كلمة المرور يجب أن تحتوي على حرف واحد على الأقل.',
            'numbers' => 'عذراً، كلمة المرور يجب أن تحتوي على رقم واحد على الأقل.',
            'symbols' => 'عذراً، كلمة المرور يجب أن تحتوي على رمز واحد على الأقل.',
            'mixed' => 'عذراً، كلمة المرور يجب أن تحتوي على حرف كبير وحرف صغير على الأقل.',
        ],
        'new_password' => [
            'min' => 'عذراً، كلمة المرور الجديدة يجب أن لا تقل عن 8 أحرف.',
            'confirmed' => 'عذراً، تأكيد كلمة المرور غير متطابق. يرجى إدخال نفس كلمة المرور في الحقلين.',
        ],
        'phone' => [
            'invalid' => 'عذراً، رقم الجوال غير صحيح. يجب أن يبدأ بـ 05 أو 9665.',
        ],
    ...
    */
    ...
    'attributes' => [
        ...
        'trainer_license' => 'رخصة المدرب',
        'national_id' => 'رقم الهوية الوطنية',
        'bachelor_certificate' => 'شهادة البكالوريوس',
        'passport_number' => 'رقم جواز السفر',
        'cv' => 'السيرة الذاتية',
        'experience_certificates' => 'شهادات الخبرة',
    ...
    'subject_parent_self' => 'لا يمكن أن تكون المادة أباً لنفسها.',
    'circular_hierarchy' => 'لا يمكن أن تحتوي بنية المواد على علاقات دائرية (تكرارية).',
];
